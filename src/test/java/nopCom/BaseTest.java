...
public class BaseTest extends BasePage {
    ...
    // created a object of BrowserSetup class to call the methods
    BrowserSetup browserSetup = new BrowserSetup();

    @BeforeMethod

    public void toOpenBrowser(){
        //the object browserSetup is using the method selectBrowser
        browserSetup.selectBrowser();
        // Using implicity wait for 20 seconds
        driver.manage().timeouts().implicitlyWait(20,TimeUnit.SECONDS);
        // using to maximize the browser window
        driver.manage().window().maximize();
        //using to open the website
